...
- **Plotting With As Few Lines As Possible:** no need to type
  ...
  `scale_y_continuous()` anymore, just one
...
- **New Clean Theme:** Includes
  ...
  a new minimalist theme based on `theme_minimal()` that is further
  optimised for clear and professional outputs, therefore perfect for
  PDF publications, scientific manuscripts, and presentations.
...
Like [`plot()`](https://rdrr.io/r/graphics/plot.default.html), just pass
`x`, `y` in the way you prefer:
...
[LICENSE](https://msberends.github.io/plot2/LICENSE.md) file for
details.
