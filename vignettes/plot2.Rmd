...
In `ggplot2`, custom fonts often require additional packages like `showtext` or manual adjustments in theme settings. `plot2()` simplifies this by handling font integration directly, including automatic downloading and scaling.
