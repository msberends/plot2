...
`plot2()` shines when it comes to more complex plot types, such as geography plots, UpSet plots, back-to-back (butterfly) plots, dumbbell plots and Sankey diagrams.
